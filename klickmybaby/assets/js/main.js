...
!(function($) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var carousel = new bootstrap.Carousel(myCarousel, {
      interval: 1500, // Interval for the slides in milliseconds
      ride: 'carousel', // Automatically start cycling the carousel
    });

    // Optional: Manually control the carousel with buttons or other actions
